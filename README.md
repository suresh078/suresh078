...
suresh = {
    ...
    "mission"    : "Turn messy data into decisions that matter.",
    "currently"  : ["Building AI-powered dashboards",
                    "Exploring NLP & ML pipelines",
...
- Analysed channel performance data across **500+ creators** at one of South India's largest MCNs
- Built an AI-powered dashboard for tracking content and revenue metrics
- Worked with **PyDejavu** and **Olaf** for audio fingerprinting to identify music assets
- Surfaced content trends and audience behaviour to support data-driven decisions
